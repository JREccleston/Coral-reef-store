...
function HomePage() {
  return (
    <div className=" bg-b2  w-full h-full">
      ...
      <div>
        <div className='ms:mt-20 bs:mt-20'>
          <HomePageText />
        </div>
        <div className='lg:flex lg:flex-row lg:items-center lg:justify-center lg:mt-20 lg:gap-10  flex flex-col items-center justify-center mt-20 ms:gap-10 bs:gap-10 xs:items-center xs:justify-center xs:flex xs:flex-col xs:gap-10'>
