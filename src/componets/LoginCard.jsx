        ...
        <Card className="w-96 text-center mx-auto mt-20 bg-sky100 font-kalam">
            ...
            <CardBody className="flex flex-col gap-10">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <Input type="email" variant="standard" value={email} onChange={(e) => setEmail(e.target.value)} label="Email" size="lg" id="email" name="email" className="text-xl" color="orange" />
                    </div>
                    <div className="mb-2">
                        <Input type='password' variant="standard" value={pass} onChange={(e) => setPass(e.target.value)} label="Password" size="lg" id="password" name="password" className="text-xl" color="orange" />
                    </div>
